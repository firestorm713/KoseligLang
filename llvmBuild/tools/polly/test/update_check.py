...
polly_src_dir = '''D:/GithubRepos/KoseligLang/llvm/tools/polly'''
polly_lib_dir = '''D:/GithubRepos/KoseligLang/llvmBuild/tools/polly/lib'''
shlibext = '''.dll'''
llvm_tools_dir = '''D:/GithubRepos/KoseligLang/llvmBuild/$(Configuration)/bin'''
link_polly_into_tools = not '''ON'''.lower() in {'','0','n','no','off','false','notfound','link_polly_into_tools-notfound'}
