...
set(Polly_INCLUDE_DIRS D:/GithubRepos/KoseligLang/llvm/tools/polly/include;D:/GithubRepos/KoseligLang/llvmBuild/tools/polly/lib/External/isl/include;D:/GithubRepos/KoseligLang/llvm/tools/polly/lib/External/isl/include;D:/GithubRepos/KoseligLang/llvmBuild/tools/polly/include ${LLVM_INCLUDE_DIRS})
set(Polly_LIBRARY_DIRS D:/GithubRepos/KoseligLang/llvmBuild/tools/polly/lib)
...
if (NOT TARGET PollyISL)
  add_library(PollyISL SHARED IMPORTED)
endif()
...
if (NOT TARGET Polly)
  add_library(Polly SHARED IMPORTED)
